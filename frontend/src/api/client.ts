...
// scopedURL rewrites an /api/v1/* request to a selected federation site by
// routing it through the hub's transparent proxy, so every existing page works
// against a remote site with no per-page changes.
