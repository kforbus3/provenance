...
// NewRoleDataSource is the prov_role data source factory. It resolves a role by
...
type roleDataSource struct{ client *prov.Client }
...
func (d *roleDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Look up a Provenance role by name.",
