// Package fleet is the official Go client for the Provenance API.
//
...
// Basic use:
//
//	c, err := prov.New("https://provenance.example.com", prov.WithToken(os.Getenv("PROV_API_TOKEN")))
//	if err != nil { log.Fatal(err) }
//	hosts, err := c.ListHosts(ctx, prov.ListOptions{})
//
...
// Client talks to a Provenance deployment. It is safe for concurrent use.
type Client struct {
...
// New creates a Client for the deployment at baseURL (e.g. "https://provenance.example.com").
