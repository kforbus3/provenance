...
Provenance is a Go + React Privileged Access Management (PAM) platform for
...
|-----|----------|----------------|
| [installation.md](./installation.md) | operators | Install and stand up Provenance from scratch: prerequisites, config, first boot |
...
Provenance manages machines that already exist; **Flipside** builds the operating
...
cannot reach it afterwards and each machine's agent polls instead. Provenance
...
and healthy). Provenance supplies reach, identity, roles and the audit trail. See
