...
What Blackfriars promises to keep working, for how long, and what it reserves
...
Blackfriars follows [Semantic Versioning](https://semver.org). Given
`MAJOR.MINOR.PATCH`:
...
- **The database schema itself.** Read Blackfriars's tables directly and a migration
