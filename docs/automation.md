...
```bash
go install github.com/kforbus3/Moorgate/sdk/cmd/fleet@latest
```
...
```bash
go get github.com/kforbus3/Moorgate/sdk@latest
```
...
[SDK README](https://github.com/kforbus3/Moorgate/tree/main/sdk).
