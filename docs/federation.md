...
Federation turns one Provenance instance into a **hub** — a single pane of
glass over many independent **site** instances, each a full Provenance stack on its
...
Each stack — hub and every site — is a full Provenance deployment with its own database and
